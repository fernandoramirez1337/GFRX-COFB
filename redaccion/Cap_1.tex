...
El Capítulo~\ref{chap:proposal} describe la propuesta de integración GFRX+COFB, incluyendo la arquitectura del sistema, metodología de implementación, enfoque de validación y evaluación, así como los resultados esperados.
