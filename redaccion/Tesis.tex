...
\setcounter{page}{1}
\input{Cap_1} %Inserta el capítulo 1: Introducción
\input{Cap_2} %Inserta el capítulo 2: Estado del Arte/Marco Teórico
\input{Cap_3} %Inserta el capítulo 3: Propuesta
